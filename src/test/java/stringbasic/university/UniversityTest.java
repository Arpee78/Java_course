...
class UniversityTest {
    ...
    void init() {
        ...
        Person person = new Person("Kovács Péter", "kovacsp@gmail.com", "123456789","12345678-87654321-12345678", "+3620-1234567");
        student = new Student(person, "A1B2C3", "9876543210");

        Person samePerson = new Person("Peter Schmidt", "pschmidt@gmail.com", "1010101010","12345678-87654321-00000000", "+43-681-12345678");
        sameStudent = new Student(samePerson, "A1B2C3", "9876543210");

        Person anotherPerson = new Person("Kovács Péter", "kovacsp@gmail.com", "123456788","12345678-87654321-12345678", "+3620-1234567");
